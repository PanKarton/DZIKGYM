...
const styles = {
  paragraph: "mt-4 text-sm text-(--offWhite) leading-relaxed ",
};
      ...
      <div className="content-max-width">
        <div className="flex gap-10 items-center">
          <div className="flex-col flex-center">
            <h2 className="text-(--blue) text-[2.5rem] font-black italic leading-none mb-2">
          ...
          <div className="w-full max-w-132 aspect-square bg-neutral-200 rounded-2xl relative overflow-hidden shrink-0">
            <Image src="/crowd.jpg" alt="tłum na siłowni DZIK GYM" fill />
          </div>
        </div>
      </div>
    </section>
