      ...
      <div className="content-max-width">
        ...
        <div className="w-full founders-gradient flex justify-center text-white aspect-[2] rounded-2xl overflow-hidden p-6 md:p-16 mb-16 relative">
          <div className="absolute inset-0 z-[-1]">
            <Image src="/wk-team.jpg" alt="Założyciele WK" fill priority />
          </div>
          <div className="flex-col flex-center gap-8  mt-auto">
            <h3 className="text-xl md:text-[2.5rem] font-bold leading-[0.5] italic text-[var(--blue)]">
              Początki Ekipy WK
            </h3>
        ...
        <div className="grid lg:flex gap-8 items-center">
          ...
          <div>
            <h3 className="text-xl md:text-3xl font-extrabold italic text-[var(--secondary)] mb-4">
              Lorem ipsum
            </h3>
            <p className="text-sm  text-[var(--secondary)]/80 mb-6">
